...
const B: fn() -> Monomial = || Monomial::new(Number::from(5) / 2, 0);
const C: fn() -> Monomial = || Monomial::new(1, 1);
const D: fn() -> Monomial = || Monomial::new(Number::from(5) / 2, 1);
const E: fn() -> Monomial = || Monomial::new(1, 4);
const F: fn() -> Monomial = || Monomial::new(Number::from(5) / 2, 4);
